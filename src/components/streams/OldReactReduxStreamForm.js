...
class OldReactReduxStreamForm extends React.Component {
...
// redux form is wrapping StreamForm component
export default reduxForm({
    form: 'streamForm', // just a name of the form
    validate
})(OldReactReduxStreamForm); // reduxForm() will return a f() and we immediately call this f() with StreamCreate
